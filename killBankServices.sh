...
pkill -f 'python3 OnlineBankingServer'
pkill -f 'python3 AccountInformationServer'
pkill -f 'python3 MoneyTransferServer'
pkill -f 'python3 AccountInformationDBServer'
