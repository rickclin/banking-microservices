...
function _M.updateContactInformation()
 ...
 local ContactInformationClient = require 'bank_ContactInformation'
 local ngx = ngx
 ...
 local client = GenericObjectPool:connection(ContactInformationClient, 'contact-information', 9090)
