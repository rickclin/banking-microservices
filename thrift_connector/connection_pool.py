...
# adapted from the original source (https://github.com/Thriftpy/thrift_connector)
# instead of Buffered transport, we use Framed transport here
...
class ThriftPyCyClient(ThriftPyBaseClient):
    ...
    @classmethod
    def get_transport_factory(self):
        from thriftpy2.transport import TCyFramedTransportFactory
        return TCyFramedTransportFactory().get_transport
